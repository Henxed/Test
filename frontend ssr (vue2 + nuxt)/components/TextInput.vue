<template>
  <div :class="$attrs.class" class="mb-2">
    ...
    <input :id="id" ref="input" v-bind="$attrs" class="form-input pr-8 disabled:opacity-60 disabled:cursor-not-allowed" :class="{ error: error }" :type="type" :value="value" @input="$emit('input', $event.target.value)" />
